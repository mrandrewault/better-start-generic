...
const topics=[
  {id:"music",label:"Music",color:"red",children:["Hip-hop all day","Jam bands","Indie","More rock, less talk","Country AND western","Classical","Close enough for jazz","Last night a DJ saved my life","R&B + soul","Global sounds","Live music","New releases"]},
  {id:"film",label:"Movies + TV",color:"blue",children:["Opening weekend","Great television","Old movies forever","Documentaries","Make me laugh","Around the world in 80 films","Animation is cinema","How movies get made","Practical magic","Cult classics"]},
  ...
  {id:"sports",label:"Sports",color:"rust",children:["NFL + fantasy football","Baseball is a way of life","Basketball","Women’s sports","The beautiful game","Tennis, anyone?","College sports","Motor racing","Golf without the whispering","Great sports stories","Sports history"]},
  ...
  {id:"design",label:"Art + design",color:"blue",size:"lg",children:["Architecture","Graphic design","Fine art","Illustration + comic art","Poster art","Furniture","Museums","Typography","Photography as art","Craft","Creative studios","Public art"]},
